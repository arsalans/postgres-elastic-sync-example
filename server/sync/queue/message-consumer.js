...
const decorated_queue_object_1 = require("./decorated-queue-object");
const elastic_request_router_1 = require("../elastic/elastic-request-router");
let logger = require("../../logger");
class MessageConsumer {
    constructor(ip, port, username, password, destination) {
        let connectOptions = {
            'host': ip,
            'port': port,
            'connectHeaders': {
        ...
        stompit.connect(connectOptions, function (error, client) {
            ...
            client.subscribe(subscribeHeaders, function (error, message) {
                ...
                message.readString('utf-8', function (error, body) {
                    ...
                    let decoratedQueueObject = decorated_queue_object_1.DecoratedQueueObject.fromJson(body);
                    ...
                    //   });
                    //client.ack(message);
                    let p1 = elastic_request_router_1.elasticRequestRouter(decoratedQueueObject.getObjectId, decoratedQueueObject.getRequestType, decoratedQueueObject.getObject, decoratedQueueObject.getIndex);
                    p1.then(() => {
...
let messageConsumer = new MessageConsumer('127.0.0.1', 61613, 'user', 'pw', '/queue/queue1');
